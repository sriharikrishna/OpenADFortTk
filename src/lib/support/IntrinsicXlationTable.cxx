...
namespace fortTkSupport { 
  ...
  IntrinsicXlationTable::Entry IntrinsicXlationTable::ourTable[] = {
    ...
    { { WNCall,     OPR_CALL,         "REAL",    1, 0 }, { XAIFIntrin, "real_int_scal",             "0_REAL",        1 } },
    { { WNCall,     OPR_CALL,         "FLOAT",   1, 0 }, { XAIFIntrin, "real_int_scal",             "1_REAL",        1 } },
    { { WNCall,     OPR_CALL,         "DBLE",    1, 0 }, { XAIFIntrin, "real_int_scal",             "2_REAL",        1 } }, 
    ...
    { { WNExpr,     OPR_BNOT,         NULL,      1, 0 }, { XAIFBoolOp, "not",                       "1_not_bitwise", 1 } },
    { { WNExpr,     OPR_BAND,         NULL,      2, 0 }, { XAIFBoolOp, "and",                       "1_and_bitwise", 2 } },
    { { WNExpr,     OPR_BIOR,         NULL,      2, 0 }, { XAIFBoolOp, "or",                        "1_or_bitwise",  2 } },
    { { WNExpr,     OPR_BXOR,         NULL,      2, 0 }, { XAIFBoolOp, "xor",                       "1_xor_bitwise", 2 } }, 
    { { WNExpr,     OPR_LNOT,         NULL,      1, 0 }, { XAIFBoolOp, "not",                       "0_not_logical", 1 } },
    { { WNExpr,     OPR_LAND,         NULL,      2, 0 }, { XAIFIntrin, "and",                       "0_and_logical", 2 } },
    { { WNExpr,     OPR_LIOR,         NULL,      2, 0 }, { XAIFIntrin, "or",                        "0_or_logical",  2 } },
    { { WNExpr,     OPR_CAND,         NULL,      2, 0 }, { XAIFIntrin, "bogus_cand_scal_scal",      NULL,            2 } },
    { { WNExpr,     OPR_CIOR,         NULL,      2, 0 }, { XAIFIntrin, "bogus_cor_scal_scal",       NULL,            2 } }, 
