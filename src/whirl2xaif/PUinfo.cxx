...
xml::ostream*    PUinfo_local_decls = NULL;  /* Tokens for local decls */
xml::ostream*    PUinfo_pragmas = NULL;      /* Tokens for PU level pragmas */
...
PUinfo_init_pu(const WN *pu, WN *body_part_of_interest)
{
   ...
   //FIXME PUinfo_local_decls  = New_Token_Buffer();
   //FIXME PUinfo_pragmas  = New_Token_Buffer();
...
PUinfo_exit_pu(void)
{
   ...
   if (PUinfo_local_decls != NULL) {
     //FIXME Reclaim_Token_Buffer(&PUinfo_local_decls);
   }
   if (PUinfo_pragmas != NULL) {
     //FIXME Reclaim_Token_Buffer(&PUinfo_pragmas);
   }
